...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('delete', app($dataType->model_name))
            ...
            @endif
        @endcan
        <form class="" id="gym-memberships"  action="{{ route('gym.memberships').'?all=true' }}" method="post" >
                @csrf
                <button class="btn btn-dark" id="submit-gym-membership" type="submit">{{__('Create Membership Invoice for all')}}</button>
        </form>
